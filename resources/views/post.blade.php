    ...
    <div class="mv_cover_filter">
        <div class="mv_inner">
            ...
            <div class="inner_right">
                <div>
                    <button class="mv_mailbtn"><a href="{{ route('register')}}">メールアドレスで登録する</a></button>
                    ...
                    <li class="question_list d-flex py-3">
                        ...
                        <div class="question_list_body pl-4 w-75">
                            ...
                            <div class="d-flex justify-content-end user_content">
                                ...
                                <p class="mr-3 "><a
                                        href="{{ Route('show_user',['id' => $post->user->id])}}">{{ $post->user->screen_name}}</a>
                                </p>
            ...
            <div class="col-sm-3">
                <div class="mb-5">
                    ...
                    <div class="boardgame_tag_wrap py-2 flex is-between">
                        ...
                        <p>
                            <span class="boradgame_tag_post">{{ $boardgame->posts->count() }}</span>
                            <span class="boradgame_tag_post">投稿</span>
                        </p>
                    </div>
                    @endif
                    @endforeach
